...
/// any other functions. \param esContext Application context
//
...
///         R,G,B channels ES_WINDOW_ALPHA   - specifies that the color buffer
///         should have alpha ES_WINDOW_DEPTH   - specifies that a depth buffer
///         should be created ES_WINDOW_STENCIL - specifies that a stencil
///         buffer should be created ES_WINDOW_MULTISAMPLE - specifies that a
...
/// time step \param esContext Application context \param updateFunc Update
/// callback function that will be used to render the scene
//
...
/// output log \param type Type of shader (GL_VERTEX_SHADER or
/// GL_FRAGMENT_SHADER) \param shaderSrc Shader source string \return A new
/// shader object on success, 0 on failure
//
...
/// triangle strip \return The number of indices required for rendering the
/// buffers (the number of indices stored in the indices array
...
/// new matrix in result \param result Specifies the input matrix.  Scaled
/// matrix is returned in result. \param sx, sy, sz Scale factors along the x, y
...
/// return new matrix in result \param result Specifies the input matrix.
/// Translated matrix is returned in result. \param tx, ty, tz Scale factors
...
/// new matrix in result \param result Specifies the input matrix.  Rotated
/// matrix is returned in result. \param angle Specifies the angle of rotation,
/// in degrees. \param x, y, z Specify the x, y and z coordinates of a vector,
/// respectively
//
...
/// planes \param bottom, top Coordinates for the bottom and top horizontal
/// clipping planes \param nearZ, farZ Distances to the near and far depth
...
//
/// \brief multiply matrix specified by result with a perspective matrix and
/// return new matrix in result \param result Specifies the input matrix.  new
/// matrix is returned in result. \param fovy Field of view y angle in degrees
...
/// \brief multiply matrix specified by result with a perspective matrix and
/// return new matrix in result \param result Specifies the input matrix.  new
/// matrix is returned in result. \param left, right Coordinates for the left
/// and right vertical clipping planes \param bottom, top Coordinates for the
/// bottom and top horizontal clipping planes \param nearZ, farZ Distances to
/// the near and far depth clipping planes.  These values are negative if plane
...
/// matrix \param result Returns multiplied matrix \param srcA, srcB Input
