...
class APHELION_API Texture {
 public:
  ...
  // our render api uses. This should rather be inside of a resource manager
  // class that maps paths to texture objects
  //
  // TODO: Create a resource manager class (for serialization purposes, right
  // now I just store the path inside of the components)
